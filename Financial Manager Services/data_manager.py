...
class DataManager:
    ...
    def add_income(self, date: str, source: str, amount: float, notes: str = None):
        income_entry = {
    ...
    def update_income(self, income_id: int, date: str = None, source: str = None, amount: float = None, notes: str = None):
    ...
    def add_expense(self, date: str, category: str, amount: float, description: str = None, is_tax_deductible: bool = False):
        expense_entry = {
    ...
    def update_expense(self, expense_id: int, date: str = None, category: str = None, amount: float = None, description: str = None, is_tax_deductible: bool = None):
